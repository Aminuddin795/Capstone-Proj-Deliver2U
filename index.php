...
<body class="home">
    <div class="site-wrapper animsition" data-animsition-in="fade-in" data-animsition-out="fade-out">
        ...
        <section class="hero bg-image" data-image-src="images/fast-food-e21500cbfa.jpg">
            <div class="hero-inner">
                <div class="container text-center hero-text font-white">
                    ...
                    <h5 class="font-white space-xs">Feel Hungry? Find your favourite delicious hot food!</h5>
                    <div class="banner-form">
                        <form class="form-inline" method="post" name="search" action="search-food.php">
                            <div class="form-group">
                                <label class="sr-only" for="exampleInputAmount">I wanna like to eat....</label>
                                <div class="form-group">
        ...
        <div class="location-match text-xs-center">
            <div class="container"> <span>Popular Delicious Foods Here: <span class="primary-color">All Around Kuala Lumpur</span> </span>
            </div>
        </div>
            ...
            <div class="container">
                    ...
                    <div class="row how-it-works-solution">
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col1">
                            <div class="how-it-works-wrap">
                                <div class="step step-1">
                                    ...
                                    <h3>Choose a craving dish</h3>
                                    <p>We"ve got your covered with the menus favourite malaysian</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-xs-12 col-sm-12 col-md-4 how-it-works-steps white-txt col2">
                            <div class="step step-2">
                                ...
                                <p>Covered all area around kuala lumpur</p>
                            </div>
                        </div>
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
                        <p class="pay-info">Special Delivery!! Pay a Cash after food delivered</p>
                    </div>
                </div>
            </div>
        </section>
